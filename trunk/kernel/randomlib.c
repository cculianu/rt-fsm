...
/*
   ...
   machines with at least 21802
	4-bit mantissas in the floating point
   representation).
...
/*
   ...
   NOTE: The seed variables can have values between: 1802   0 <= IJ <= 31328
                                                        0 <= KL <= 30081
...
double RandomUniform(void)
{
   ...
   if (!test) 
   	RandomInitialise(time(NULL)%31320,time(NULL)%23454);
